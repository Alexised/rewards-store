...
myHeaders.append(
	'Authorization',
	'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2MDRjYjkzMDdlNzE4NzAwMjBlMzhmNWEiLCJpYXQiOjE2MTU2NDA4ODB9.PPS0LNLAwebxbblxc8uUFrryta1azSfOmX-9bnvTQpU'
);
...
export const getReedem = async (productId) => {
	...
	try {
		const result =await fetch(`${API_URL}/redeem`, requestOptions);
